...
namespace app.DAO
{
    public class AuthDAO
    {
        ...
        public async Task<UserRegisterDTO> UserRegister(UserRegisterDTO dto)
        {
            ...
            objInsert.Append("INSERT INTO \"Livraria\".\"AspNetUsers\"(");
        ...
        public async Task<List<GetAllUserResponse>> GetAllUsers()
        {
            ...
            objSelect.Append("SELECT * FROM \"Livraria\".\"AspNetUsers\"");
        ...
        public async Task<UserRolesDTO> InsertRole(UserRolesDTO dto)
        {
            ...
            objInsert.Append("INSERT INTO \"Livraria\".\"AspNetRoles\"(");
        ...
        public async Task<bool> InsertAspNetUserRoles(string userId, string roleId)
        {
            ...
            {
                var objInsert = new StringBuilder();
                objInsert.Append("INSERT INTO \"Livraria\".\"AspNetUserRoles\"(userid, roleid)\r\n");
                objInsert.Append("VALUES (\r\n");
        ...
        public async Task<UserRolesDTO> GetAspNetUserRoles(string email)
        {
            ...
            objSelect.Append("FROM \"Livraria\".\"AspNetUserRoles\"\r\n");
            objSelect.Append("LEFT JOIN \"Livraria\".\"AspNetRoles\" ON \"AspNetUserRoles\".roleid = \"AspNetRoles\".id\r\n");
            objSelect.Append("LEFT JOIN \"Livraria\".\"AspNetUsers\" ON \"AspNetUserRoles\".userid = \"AspNetUsers\".id\r\n");
        ...
        public async Task<UserDTO> UpdateUser(UserDTO dto)
        {
            ...
            objUpdate.Append("UPDATE \"Livraria\".\"AspNetUsers\" ");
